...
Begin VB.Form frm_MPTotalByTask 
   Caption         =   "Summary"
   ClientHeight    =   10005
   ClientLeft      =   60
   ClientTop       =   345
   ...
   End
End
Attribute VB_Name = "frm_MPTotalByTask"
...
Private Sub show_Summary_Plan(strMPNumber As String)
    ...
    strSql = "SELECT d.mp_task_id,d.task_desc,b.medium_code,a.month_number,"
    ...
    strSql = strSql & " GROUP BY d.mp_task_id,d.task_desc,b.medium_code,a.month_number "
