...
Begin VB.Form Frm_Cinema_Material_Catalog 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cinema Material Catalog"
   ClientHeight    =   4920
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6330
   ...
   Begin Threed.SSPanel pnl_Main 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.TextBox Txt_Duration 
            ...
            Width           =   975
         End
         Begin VB.ComboBox cboJenisDurasi 
            Appearance      =   0  'Flat
            Enabled         =   0   'False
            BeginProperty Font 
               Name            =   "Tahoma"
   ...
   End
End
Attribute VB_Name = "Frm_Cinema_Material_Catalog"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'''*************************************************************
'Nama Form          : Frm_Cinema_Material_Catalog
'Fungsi Form        : untuk menambah, edit, delete material Cinema
'Programer          : sistyo
...
Private Sub db_edit()
    ...
    If RS_Materi.State = adStateOpen Then
        If Not RS_Materi.EOF Then
            ...
            cboJenisDurasi.Text = RS_Materi.Fields("jenis_durasi").Value
            Txt_Duration.Enabled = True
            Txt_Materi_Name.Enabled = True
            cboJenisDurasi.Enabled = True
            Edit = True
...
Private Sub db_save()
    ...
    If Trim(Txt_Duration.Text) = "" Then
        ...
        Exit Sub
    End If
    'MsgBox "Call ToggleButton(False)"
    With RS_Materi
        If Not Edit Then
            .AddNew
            ...
            .Fields("jenis_durasi").Value = cboJenisDurasi.Text
            .Update
        Else
            .Fields("brand_code").Value = Left(Cbo_Brand.Text, 4)
            .Fields("material_name").Value = Txt_Materi_Name.Text
...
Private Sub Form_Load()
    ...
    Dim rs_jenis_durasi As New ADODB.Recordset
    
    rs_jenis_durasi.Open "select distinct jenis from cinema_rate", ConnERP, 1, 3
    cboJenisDurasi.Clear
    While Not rs_jenis_durasi.EOF
        cboJenisDurasi.AddItem rs_jenis_durasi(0)
        rs_jenis_durasi.MoveNext
    Wend
    rs_jenis_durasi.Close
...
Public Sub Clear_Form()
    ...
    cboJenisDurasi.ListIndex = -1
End Sub

Public Sub Load_Data()
    
        strSql = "SELECT * FROM cinema_Material WHERE "
